...
// CSceneX生成
//------------------------------------------------
CSceneX *CSceneX::Create(int nType, Vector3 pos, Vector3 rot)
{
	CSceneX *pSceneX;
...
// コンストラクタ
//------------------------------------------------
CSceneX::CSceneX(int nPriority, CScene::OBJECT_TYPE objType, CScene::SCENE_TYPE SceneType) : CScene(nPriority, objType, SceneType)
{
	m_pTexture = NULL;
	m_pMesh = NULL;
	m_pBuffMat = NULL;
...
// 初期化処理
//------------------------------------------------
HRESULT CSceneX::Init(int nType, Vector3 pos, Vector3 rot)
{
