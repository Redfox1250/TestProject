...
void CLight::SetLight(void)
{
	...
	//ライト0
	{
		...
		// ライトの方向の設定
		vecDir = Vector3(0.20f, -0.60f, 0.80f);
		D3DXVec3Normalize((Vector3*)&m_aLight[0].Direction, &vecDir);
	...
	//ライト1
	{
		...
		// ライトの方向の設定
		vecDir = Vector3(-0.20f, 1.00f, -0.50f);
		D3DXVec3Normalize((Vector3*)&m_aLight[1].Direction, &vecDir);
	...
	//ライト2
	{
		...
		// ライトの方向の設定
		vecDir = Vector3(-0.20f, -0.60f, -0.80f);
		D3DXVec3Normalize((Vector3*)&m_aLight[2].Direction, &vecDir);
